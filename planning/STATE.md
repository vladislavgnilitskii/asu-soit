...
> **Обновление 2026-07-08 — выполнены Этапы 0–5.** Закрыты все security-дыры, устранён тех-долг, миграция 009 применена; реализованы устройства, организации, полный жизненный цикл заявки, склад, финансы и управление сотрудниками. Сборка/vet/тесты проходят (Go 1.26.4). Решения — в `DECISIONS.md`, следующая задача — в `CURRENT_TASK.md`.
