...
> **Обновление 2026-07-08 — выполнены Этапы 0, 1, 2, 3 и 4.** Закрыты все security-дыры, устранён тех-долг, миграция 009 применена, добавлены модуль устройств, полноценные организации, полный жизненный цикл заявки, модуль склада и модуль финансов (счёт по заявке, оплата/отмена). Сборка/vet/тесты проходят (Go 1.26.4). Решения — в `DECISIONS.md`, следующая задача — в `CURRENT_TASK.md`.
